...
class MetaSettings(Base):
    ...
    field_phone_name_update: Mapped[bool] = mapped_column(Boolean, default=True)
    ...
    # WhatsApp display-name review audit (webhook + admin actions). PIN never stored.
    display_name_requested: Mapped[str] = mapped_column(String(200), default="")
    display_name_decision: Mapped[str] = mapped_column(String(40), default="")
    display_name_rejection: Mapped[str] = mapped_column(String(500), default="")
    display_name_event_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    display_name_history: Mapped[str] = mapped_column(Text, default="[]")
