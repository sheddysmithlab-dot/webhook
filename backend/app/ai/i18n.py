...
_HI = {
    ...
    "photos": "जी सर. कृपया साफ फोटो भेज दीजिए — आगे और दोनों साइड से.",
    "more_detail": "सर, थोड़ा और बता दीजिए.",
    "photo_fail": "सर, फोटो नहीं आई. कृपया एक बार और भेज दीजिए.",
    "photo_more": "जी, आ गई. पीछे और केबिन की भी हो तो भेज दीजिए.",
    "photo_note": "फोटो मिल गई सर. और हों तो भेज दीजिए, नहीं तो टीम को दे देता हूँ.",
    "photos_enough": "जी सर. इतनी फोटो काफी हैं.",
    ...
    "vehicle_new_ok": "जी सर — नई गाड़ी. नई लिस्टिंग के लिए डिटेल ले रहा हूँ.",
...
_EN = {
    ...
    "photos": "Thank you Sir. Kindly send clear photos — front and both sides.",
    "more_detail": "Sir, a little more detail please.",
    "photo_fail": "Sir, the photo did not come through. Please send it once more.",
    "photo_more": "Received, Sir. Rear and cabin too, if you have them.",
    "photo_note": "Photos noted, Sir. More if you have them; else I will pass this to the team.",
    "photos_enough": "Thank you Sir. These photos are enough.",
...
_HINGLISH = {
    ...
    "photos": "Ji Sir. Kripya saaf photos bhej dijiye — aage aur dono side se.",
    "more_detail": "Sir, thoda aur bata dijiye.",
    "photo_fail": "Sir, photo nahi aayi. Kripya ek baar aur bhej dijiye.",
    "photo_more": "Ji, mil gayi. Piche aur cabin ki bhi ho to bhej dijiye.",
    "photo_note": "Photos mil gayi Sir. Aur hon to bhej dijiye, nahi to team ko de deta hoon.",
    "photos_enough": "Ji Sir. Itni photos kaafi hain.",
