...
_HI = {
    ...
    "card_cleanup_warn": "सर, 1 मिनट में {card} की यह conversation clear हो जाएगी. Listing data safe रहेगी — सिर्फ live chat detail हट रही है.",
    "card_conversation_deleted": "सर, {card} की ऐप conversation delete कर दी गई है. Listing data memory में सुरक्षित है. अब नई listing के लिए फिर से डिटेल भेज सकते हैं.",
    ...
    "listing_approved": "सर, आपकी listing ({card}) APPROVE हो गई है.",
    "listing_approved_note": "सर, आपकी listing ({card}) APPROVE हो गई है.\n\nNote: {reason}",
    "listing_approved_link": "सर, आपकी listing ({card}) APPROVE हो गई है / InfraDealer पर लाइव है:\n\n{url}",
    "listing_approved_link_note": "सर, आपकी listing ({card}) APPROVE हो गई है / InfraDealer पर लाइव है:\n\n{url}\n\nNote: {reason}",
    "listing_rejected": "सर, आपकी listing ({card}) REJECT हो गई है.",
    "listing_rejected_reason": "सर, आपकी listing ({card}) REJECT हो गई है.\n\nReason: {reason}",
...
_EN = {
    ...
    "card_cleanup_warn": "Sir, in 1 minute the {card} conversation will be cleared. Listing data stays safe — only the live chat details are removed.",
    "card_conversation_deleted": "Sir, the app conversation for {card} has been deleted. Listing data remains in memory. You can send details again for a new listing.",
    ...
    "listing_approved": "Sir, your listing ({card}) has been APPROVED.",
    "listing_approved_note": "Sir, your listing ({card}) has been APPROVED.\n\nNote: {reason}",
    "listing_approved_link": "Sir, your listing ({card}) has been APPROVED / is live on InfraDealer:\n\n{url}",
    "listing_approved_link_note": "Sir, your listing ({card}) has been APPROVED / is live on InfraDealer:\n\n{url}\n\nNote: {reason}",
    "listing_rejected": "Sir, your listing ({card}) has been REJECTED.",
    "listing_rejected_reason": "Sir, your listing ({card}) has been REJECTED.\n\nReason: {reason}",
...
_HINGLISH = {
    ...
    "card_cleanup_warn": "Sir, 1 minute me {card} ki ye conversation clear ho jayegi. Listing data safe rahegi — sirf live chat detail hat rahi hai.",
    "card_conversation_deleted": "Sir, {card} ki app conversation delete kar di gayi hai. Listing data memory me safe hai. Ab nayi listing ke liye phir se detail bhej sakte hain.",
    ...
    "listing_approved": "Sir, aapki listing ({card}) APPROVE ho gayi hai.",
    "listing_approved_note": "Sir, aapki listing ({card}) APPROVE ho gayi hai.\n\nNote: {reason}",
    "listing_approved_link": "Sir, aapki listing ({card}) APPROVE ho gayi hai / InfraDealer par live hai:\n\n{url}",
    "listing_approved_link_note": "Sir, aapki listing ({card}) APPROVE ho gayi hai / InfraDealer par live hai:\n\n{url}\n\nNote: {reason}",
    "listing_rejected": "Sir, aapki listing ({card}) REJECT ho gayi hai.",
    "listing_rejected_reason": "Sir, aapki listing ({card}) REJECT ho gayi hai.\n\nReason: {reason}",
